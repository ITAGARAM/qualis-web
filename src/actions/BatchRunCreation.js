                ...
                dispatch({
                    ...
                    payload: {
                        ...
                        selectedRecord : {
                            ...selectedSpec,
                            //ALPD-5952-Start
                            smaterialtypename:response.data.selectedMaterialType,
                            smaterialcatname:response.data.selectedMaterialCategory,
                            smaterialname:response.data.selectedMaterial,
                            sinventoryid:response.data.selectedMaterialInventory,
