    ...
    getREMaterialCategoryByType(inputData) {
        ...
        rsapi.post("resultentrybysample/getREMaterialCategoryByType", {
            ...
            .then(response => {
                ...
                this.props.onChildDataChange({
                    ...inputData.selectedRecordMaterialForm,
                      nmaterialcode:  materialMap.get("OptionList")[0]||"",//materialMap.get("DefaultValue") || "",
                    nmaterialinventorycode: materialInventoryMap.get("OptionList")[0]||"",//materialInventoryMap.get("DefaultValue") || "",
