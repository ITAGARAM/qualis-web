...
class BatchCreation extends React.Component {
    ...
    getIqcSamples = (SelectedBatchmaster) => {
        if (SelectedBatchmaster.ntransactionstatus == transactionStatus.INITIATED ||
            ...
            // inputData['materialtype'] = this.state.selectedMaterialType;
            // inputData['materialcategory'] = this.state.selectedMaterialCategory;
            // inputData['material'] = this.state.selectedMaterial;
            // inputData['materialinventory'] = this.state.selectedMaterialInventory;
